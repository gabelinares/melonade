...
export const TESTS: readonly TestCase[] = [
  ...
  { key: 'tc-search', title: 'Search & filter', status: 'active', stepCount: 4, createdAt: daysAgo(45), tags: ['Search'], envNames: ['Production'], schedule: WEEKDAYS, lastResult: 'passed', lastRunAt: hoursAgo(9), version: 2 },
  { key: 'tc-billing', title: 'Update billing card', status: 'active', stepCount: 4, createdAt: daysAgo(30), tags: ['Billing'], envNames: ['Staging'], schedule: MWF, lastResult: 'failed', lastRunAt: hoursAgo(11), version: 3 },
  { key: 'tc-create-project', title: 'Create project', status: 'active', stepCount: 4, createdAt: daysAgo(6), tags: ['Projects'], envNames: ['Production'], schedule: EVERY_DAY, lastResult: 'passed', lastRunAt: hoursAgo(3) },
  { key: 'tc-invite-active', title: 'Invite teammate', status: 'active', stepCount: 3, createdAt: daysAgo(52), tags: ['Settings'], envNames: ['QA'], schedule: WEEKDAYS, lastResult: 'passed', lastRunAt: hoursAgo(14) },
  { key: 'tc-2fa-active', title: 'Enable two-factor auth', status: 'active', stepCount: 4, createdAt: daysAgo(24), tags: ['Auth'], envNames: ['QA'], schedule: WEEKDAYS, lastResult: 'passed', lastRunAt: hoursAgo(20) },
  { key: 'tc-invoice', title: 'Download invoice', status: 'active', stepCount: 3, createdAt: daysAgo(71), tags: ['Billing'], envNames: ['Production'], schedule: { days: [1], time: '08:00' }, lastResult: 'passed', lastRunAt: hoursAgo(26) },
  { key: 'tc-profile', title: 'Upload profile photo', status: 'active', stepCount: 4, createdAt: daysAgo(11), tags: ['Profile'], envNames: ['Staging'], schedule: WEEKDAYS, lastResult: 'passed', lastRunAt: hoursAgo(30), version: 2, pendingRevision: { toVersion: 3, detectedAt: hoursAgo(26), changes: 1 } },

  { key: 'tc-onboarding-tour', title: 'Onboarding tour', status: 'paused', stepCount: 3, createdAt: daysAgo(95), tags: ['Onboarding'], envNames: ['Staging'], schedule: null, lastResult: 'passed', lastRunAt: hoursAgo(72) },
  { key: 'tc-bulk-export', title: 'Bulk data export', status: 'paused', stepCount: 4, createdAt: daysAgo(58), tags: ['Settings'], envNames: ['QA'], schedule: null, lastResult: 'failed', lastRunAt: hoursAgo(96) },
  { key: 'tc-logout', title: 'Logout flow', status: 'active', stepCount: 3, createdAt: daysAgo(19), tags: ['Auth'], envNames: ['QA'], schedule: WEEKDAYS, lastResult: 'passed', lastRunAt: hoursAgo(6) },
  { key: 'tc-add-payment', title: 'Add a payment method', status: 'active', stepCount: 3, createdAt: daysAgo(27), tags: ['Billing'], envNames: ['Production'], schedule: EVERY_DAY, lastResult: 'passed', lastRunAt: hoursAgo(8) },
  { key: 'tc-remove-item', title: 'Remove item from cart', status: 'active', stepCount: 3, createdAt: daysAgo(34), tags: ['Checkout'], envNames: ['Production'], schedule: WEEKDAYS, lastResult: 'passed', lastRunAt: hoursAgo(10) },
  { key: 'tc-change-password', title: 'Change password', status: 'active', stepCount: 3, createdAt: daysAgo(41), tags: ['Auth'], envNames: ['QA'], schedule: MWF, lastResult: 'failed', lastRunAt: hoursAgo(12) },
  { key: 'tc-export-csv', title: 'Export report as CSV', status: 'paused', stepCount: 3, createdAt: daysAgo(76), tags: ['Settings'], envNames: ['Staging'], schedule: null, lastResult: 'passed', lastRunAt: hoursAgo(40) },
  { key: 'tc-filter-dashboard', title: 'Filter the dashboard', status: 'active', stepCount: 3, createdAt: daysAgo(8), tags: ['Search'], envNames: ['Production'], schedule: WEEKDAYS, lastResult: 'passed', lastRunAt: hoursAgo(13) },
  { key: 'tc-share-report', title: 'Share a report', status: 'active', stepCount: 3, createdAt: daysAgo(22), tags: ['Settings'], envNames: ['Production'], schedule: WEEKDAYS, lastResult: 'passed', lastRunAt: hoursAgo(15) },
  { key: 'tc-delete-account', title: 'Delete account', status: 'paused', stepCount: 3, createdAt: daysAgo(66), tags: ['Settings'], envNames: ['QA'], schedule: null, lastResult: 'passed', lastRunAt: hoursAgo(120) },
  { key: 'tc-apply-theme', title: 'Switch to dark mode', status: 'active', stepCount: 3, createdAt: daysAgo(37), tags: ['Profile'], envNames: ['Staging'], schedule: WEEKDAYS, lastResult: 'passed', lastRunAt: hoursAgo(18) },
  { key: 'tc-resend-invite', title: 'Resend a team invite', status: 'active', stepCount: 3, createdAt: daysAgo(49), tags: ['Settings'], envNames: ['QA'], schedule: WEEKDAYS, lastResult: 'failed', lastRunAt: hoursAgo(22) },
  { key: 'tc-upgrade-plan', title: 'Upgrade plan', status: 'active', stepCount: 3, createdAt: daysAgo(83), tags: ['Billing'], envNames: ['Production'], schedule: EVERY_DAY, lastResult: 'passed', lastRunAt: hoursAgo(24) },
  { key: 'tc-search-empty', title: 'Search with no results', status: 'active', stepCount: 3, createdAt: daysAgo(15), tags: ['Search'], envNames: ['Production'], schedule: WEEKDAYS, lastResult: 'passed', lastRunAt: hoursAgo(27) },
